...
*************************************************/
uchar CRANE::calcCheckSum(uchar *buf, int Datasize)
{
  int checksum = 0;
...
*************************************************/
void CRANE::RegWrite(int id, ServoWrite data[])
{
  uchar buf[17] = {0};
...
*************************************************/
void CRANE::ReadServoAngle(int id, double ReadAngle[])
{
  uchar buf[8] = {0};
  uchar recv[8];
...
*************************************************/
int CRANE::OpenCOMDevice(const char *SERIAL_PORT)
{
...
*************************************************/
void CRANE::initServo(int id, ServoWrite data[])
{
...
*************************************************/
void CRANE::setCRANESpeeddata(int id, double spdRatio)
{
